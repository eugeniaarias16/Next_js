...
export const categoriesMap = [
    ...
    { 
      ...
      SubCategory: [
        ...
        { name: "Lip Gloss", link: "/sub-category/lip-gloss", apiCall: "product_category=lip_gloss&product_type=lipstick" },
        { name: "Lip Liner", link: "/sub-category/lip-liner", apiCall: "product_type=lip_liner" },
        { name: "Lip Stain", link: "/sub-category/lip-stain", apiCall: "product_category=lip_stain&product_type=lipstick" }
      ]
    },
    { 
      name: "Eyes", 
