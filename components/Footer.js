...
export default function Footer() {
  return (
      ...
      <footer className="px-4  text-brownn bg-ligth-brown/50 w-full">
	<div className="container  border-b-[1px] border-brownn/30 flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		...
		<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
			<div className="space-y-3">
				<h3 className="tracking-wide uppercase text-green">Product</h3>
			...
			<div className="space-y-3">
				<h3 className="tracking-wide uppercase text-green">Company</h3>
				<ul className="space-y-1">
					<li>
			...
			<div className="space-y-3">
				<h3 className="uppercase text-green">Developers</h3>
				<ul className="space-y-1">
					<li>
			...
			<div className="space-y-3">
				<div className="uppercase text-green">Social media</div>
