...
export default function SliderCards({ products, title}) {
  ...
  return (
    <div className="w-[95%] flex flex-col items-center mt-10 gap-6">
      {/* Título */}
      <div
        className="w-1/2 p-3 gradient-ligth rounded-xl bg.opa  text-center mb-4 text-4xl text-green font-semibold shadow-lg transition-transform duration-300 hover:scale-105 hover:shadow-2xl hover:text-light-sand"
      >
        {title}
      </div>
